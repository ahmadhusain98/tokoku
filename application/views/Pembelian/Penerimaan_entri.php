                          ...
                          <div class="col-sm-9">
                            <div class="row">
                              <div class="col-sm-2" style="margin-bottom: 5px;">
                                <input type="checkbox" name="cekpo" id="cekpo" class="form-control" onclick="pocek();">
                                <input type="hidden" name="cek_po" id="cek_po">
                              </div>
                              <div class="col-sm-10" id="c_po">
                                <select name="kode_po" id="kode_po" class="form-control select2_po" data-placeholder="PO (Pre Order)" onchange="get_data_po(this.value)" style="width: 100%;"></select>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-sm-9">
                            ...
                            <div class="row">
                              <div class="col-sm-6" style="margin-bottom: 5px;">
                                <input type="date" id="tgl_terima" name="tgl_terima" class="form-control" value="<?= date('Y-m-d'); ?>" <?= $dis; ?>>
                              </div>
                              <div class="col-sm-6">
                                <input type="time" id="jam_terima" name="jam_terima" class="form-control" value="<?= date('H:i:s'); ?>" <?= $dis; ?>>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
  function simpan() {
    ...
    $.ajax({
      url: "<?= site_url('Pembelian/simpan_terima/1') ?>",
      type: "POST",
      ...
      success: function(data) {
        ...
        if (data.status == 1) {
          Swal.fire({
            icon: 'success',
            html: '<span class="text-success h4 font-weight-bold">TAMBAH DATA PEMBELIAN</span><br><b>' + (data.invoice).toUpperCase() + '</b><br><br>Berhasil ditambahkan!',
          }).then((result) => {
          ...
          Swal.fire({
            icon: 'error',
            html: '<span class="text-danger h4 font-weight-bold">TAMBAH DATA PEMBELIAN</span><br><br>Gagal ditambahkan!',
          });
        }
      }
    })
