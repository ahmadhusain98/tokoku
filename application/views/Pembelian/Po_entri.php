                          ...
                          <div class="col-sm-9">
                            ...
                            <div class="row">
                              <div class="col-sm-6" style="margin-bottom: 5px;">
                                <input type="date" id="tgl_pembelian" name="tgl_pembelian" class="form-control" value="<?= date('Y-m-d'); ?>" <?= $dis; ?>>
                              </div>
                              <div class="col-sm-6">
                                <input type="time" id="jam_pembelian" name="jam_pembelian" class="form-control" value="<?= date('H:i:s'); ?>" <?= $dis; ?>>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
  function simpan() {
    ...
    $.ajax({
      url: "<?= site_url('Pembelian/simpan/1') ?>",
      type: "POST",
      ...
      success: function(data) {
        ...
        if (data.status == 1) {
          Swal.fire({
            icon: 'success',
            html: '<span class="text-success h4 font-weight-bold">TAMBAH DATA PO</span><br><b>' + (data.invoice).toUpperCase() + '</b><br><br>Berhasil ditambahkan!',
          }).then((result) => {
          ...
          Swal.fire({
            icon: 'error',
            html: '<span class="text-danger h4 font-weight-bold">TAMBAH DATA PO</span><br><br>Gagal ditambahkan!',
          });
        }
      }
    })
