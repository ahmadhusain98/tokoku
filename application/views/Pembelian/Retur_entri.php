                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <a type="button" href="<?= site_url('Pembelian/retur'); ?>" title="Kembali" class="btn btn-flat btn-danger float-right"><i class="fa-solid fa-backward"></i></a>
                            <br>
                            <br>
                            <div class="card shadow border-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Data Retur</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="kode_terima" id="kode_terima" class="form-control select2_penerimaan" data-placeholder="Penerimaan Barang" onchange="get_data_penerimaan(this.value)" style="width: 100%;"></select>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6" style="margin-bottom: 5px;">
                                                                <input type="date" id="tgl_retur" name="tgl_retur" class="form-control" value="<?= date('Y-m-d'); ?>" <?= $dis; ?>>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <input type="time" id="jam_retur" name="jam_retur" class="form-control" value="<?= date('H:i:s'); ?>" <?= $dis; ?>>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col-sm-2" style="margin-bottom: 5px;">
                                                                ...
                                                                <input type="hidden" name="cek_ppn" id="cek_ppn">
                                                            </div>
                            ...
                            <div class="card shadow border-danger">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-hover" id="retur_detail">
                                                    ...
                                                    <tbody id="datatable_body">
                                                        <tr id="tr_1">
                                                            ...
                                                            <td>
                                                                <select name="kode_barang[]" id="kode_barang1" class="form-control select2_barang" data-placeholder="Cari Barang" onchange="showbarang(this.value, 1)"></select>
                                                            ...
                                                            <td>
                                                                <input type="date" name="tgl_expire[]" id="tgl_expire1" class="form-control" value="<?= date('Y-m-d', strtotime('+2 Year')) ?>" min="<?= date('Y-m-d', strtotime('+2 Year')) ?>">
                                                            </td>
                                                            <td>
                                                                <input type="text" name="qty_barang[]" id="qty_barang1" class="form-control text-right" onchange="total_qty(1)" value="1" min="1">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" name="discrp_barang[]" id="discrp_barang1" class="form-control text-right" onchange="total_discrp(1)" value="0">
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8" style="margin-bottom: 5px;">
                                            ...
                                            <button type="button" class="btn btn-primary btn-flat float-right" id="btnSimpan" onclick="simpan()" title="Simpan Data Pembelian">Simpan <i class="fa-solid fa-save"></i></button>
                                        </div>
                                        <div class="col-sm-4">
...
<script>
    $(document).ready(function() {
        ...
        initailizeSelect2_penerimaan(cabang);
        $("#sup_ppn").hide();
    ...
    function tambah() {
        var tablex = document.getElementById("retur_detail");
        var idrow = tablex.rows.length;
        var table = $("#retur_detail");
        table.append(`<tr id="tr_` + idrow + `">
            ...
            <td>
                <input type="text" name="qty_barang[]" id="qty_barang` + idrow + `" class="form-control text-right" onchange="total_qty(` + idrow + `)" value="1" min="1">
            </td>
            <td>
    ...
    function total() {
        ...
        var table = document.getElementById("retur_detail");
...
<script>
    ...
    function get_data_penerimaan(invoice_terima) {
        if (invoice_terima == "" || invoice_terima == null) {
            hapusSemua();
            ...
            $.ajax({
                url: "<?= site_url('Pembelian/ambil_data_terima/'); ?>" + invoice_terima,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
                    $("#kode_supplier").append(`<option value="` + data.kode_supplier + `">` + data.nama_supplier + `</option>`);
                    $("#kode_gudang").append(`<option value="` + data.kode_gudang + `">` + data.nama_gudang + `</option>`);
                    if (data.pajak == 1) {
                    ...
                    ppncek();
                    get_detail_terima(invoice_terima);
                }
            });
        }
    }

    function get_detail_terima(invoice_terima) {
        $.ajax({
            url: "<?= site_url('Pembelian/ambil_detail_terima/'); ?>" + invoice_terima,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
                hapusSemua();
                ...
                $(opt).each(function() {
                    body.append(`<tr id="tr_` + no + `">
                        ...
                        <td>
                            <input type="date" name="tgl_expire[]" id="tgl_expire` + no + `" class="form-control" value="<?= date('Y-m-d', strtotime(`+opt[no].tgl_expire+`)) ?>" min="<?= date('Y-m-d', strtotime('+2 Year')) ?>">
                        </td>
                        <td>
                            <input type="text" name="qty_barang[]" id="qty_barang` + no + `" class="form-control text-right" onchange="total_qty(` + no + `)" value="` + formatRupiah(opt[no].qty) + `" min="1">
                        </td>
                        <td>
...
<script>
    function simpan() {
        ...
        $.ajax({
            url: "<?= site_url('Pembelian/simpan_retur/1') ?>",
            type: "POST",
            ...
            success: function(data) {
                ...
                if (data.status == 1) {
                    Swal.fire({
                        icon: 'success',
                        html: '<span class="text-success h4 font-weight-bold">TAMBAH DATA RETUR PENERIMAAN</span><br><b>' + (data.invoice).toUpperCase() + '</b><br><br>Berhasil direturkan!',
                    }).then((result) => {
                        location.href = "<?= site_url('Pembelian/retur'); ?>";
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
                        html: '<span class="text-danger h4 font-weight-bold">TAMBAH DATA RETUR PENERIMAAN</span><br><br>Gagal direturkan!',
                    });
                }
            }
        })
