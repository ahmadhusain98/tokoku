  ...
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" data-widget="fullscreen" href="#" role="button" title="Ukuran Layar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($user->id_role < 2) : ?>
              <li class="nav-item">
                <?php if ($this->uri->segment(1) == "Privatex") : ?>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= site_url('Privatex/master_role'); ?>" class="nav-link">
                      <i class="fa-solid fa-person-circle-question nav-icon"></i>
                      <p>Master Tingkatan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Privatex/akun'); ?>" class="nav-link">
                      <i class="fa-solid fa-users-gear nav-icon"></i>
                      <p>Aktifasi Akun</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Privatex/cabang'); ?>" class="nav-link">
                      <i class="fa-solid fa-network-wired nav-icon"></i>
                      <p>Aktifasi Cabang</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Privatex/role'); ?>" class="nav-link">
                      <i class="fa-solid fa-elevator nav-icon"></i>
                      <p>Tingkatan User</p>
                    </a>
                  </li>
                </ul>
              ...
              <li class="nav-item">
                <?php if ($this->uri->segment(1) == "Inti") : ?>
                  <a href="#" class="nav-link active">
                    <i class="fa-solid fa-code-commit nav-icon"></i>
                    <p>
                      Core
                      <i class="fas fa-angle-left right"></i>
                    </p>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= site_url('Inti/Satuan'); ?>" class="nav-link">
                      <i class="fa-solid fa-table-cells-large nav-icon"></i>
                      <p>Satuan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Inti/Kategori'); ?>" class="nav-link">
                      <i class="fa-solid fa-object-ungroup nav-icon"></i>
                      <p>Kategori</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Inti/Supplier'); ?>" class="nav-link">
                      <i class="fa-solid fa-code-branch nav-icon"></i>
                      <p>Supplier</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Inti/ppn'); ?>" class="nav-link">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= site_url('Master/anggota'); ?>" class="nav-link">
                      <i class="fa fa-users nav-icon"></i>
                      <p>Keanggotaan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Master/cabang'); ?>" class="nav-link">
                      <i class="fa-solid fa-code-branch nav-icon"></i>
                      <p>Cabang</p>
                    </a>
                  </li>
            ...
            <?php endif; ?>
            <li class="nav-item">
              <?php if ($this->uri->segment(1) == "Peoples") : ?>
                <a href="#" class="nav-link active">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= site_url('Peoples'); ?>" class="nav-link">
                    <i class="fa-solid fa-people-robbery nav-icon"></i>
                    <p>Dapatkan Teman</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= site_url('Peoples/teman'); ?>" class="nav-link">
                    <i class="fa-solid fa-people-pulling nav-icon"></i>
                    <p>Daftar Teman</p>
                  </a>
                </li>
              </ul>
            ...
            <?php if ($user->id_role < 2) : ?>
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= site_url('Pembelian/po'); ?>" class="nav-link">
                      <i class="fa-solid fa-boxes-packing nav-icon"></i>
                      <p>PO (Pre Order)</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Pembelian/terima'); ?>" class="nav-link">
                      <i class="fa-solid fa-dolly nav-icon"></i>
                      <p>Penerimaan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= site_url('Pembelian/retur'); ?>" class="nav-link">
            ...
            <li class="nav-item">
              <?php if ($this->uri->segment(1) == 'Penjualan') : ?>
                <a href="<?= site_url('Penjualan'); ?>" class="nav-link active">
